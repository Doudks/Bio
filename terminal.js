  ...
  function bootMintTerminal() {
    output.innerHTML = `
      <div class="mint-text-output">
        ...
        <div><span class="mint-key">Uptime:</span>since you were born</div>
        ...
        <div><span class="mint-key">CPU:</span> Hopes and dreams</div>
        <div><span class="mint-key">Memory:</span> 12MiB / 24MiB</div>
